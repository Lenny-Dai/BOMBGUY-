...
public class enemy2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i=1;i<=8;i++){
            star[i]=Resources.Load<Sprite>("stars/star_"+i) as Sprite;
        }
        
        transform.localPosition=new Vector3(0,100,0);
        bullet1=Resources.Load("prefabs/bulletclass") as GameObject;
        cannon=Resources.Load<Sprite>("cannon") as Sprite;
    }
